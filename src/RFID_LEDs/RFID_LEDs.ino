...
{ 
    ...
    pinMode(zachLed, OUTPUT);
    pinMode(gregLed, OUTPUT);
    digitalWrite(zachLed, LOW);
    digitalWrite(gregLed, LOW);
...
void loop()
{
    ...
    if (status == MI_OK)
    {
        ...
        uchar* id = serNum;
        if( id[0]==0x43 && id[1]==0x33 && id[2]==0x9C && id[3]==0x02 ) {
            Serial.println("Hello Zach!");
            digitalWrite(gregLed, LOW);
            digitalWrite(zachLed, HIGH);
        } else if(id[0]==0x76 && id[1]==0xC4 && id[2]==0x7E && id[3]==0x41) {
            Serial.println("Hello Greg!");
            digitalWrite(zachLed, LOW);
            digitalWrite(gregLed, HIGH);
        }else{
